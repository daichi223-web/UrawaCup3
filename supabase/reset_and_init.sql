-- =====================================================
-- 浦和カップ DB初期化スクリプト (Hard Reset)
-- 既存のテーブル・データを全て削除して作り直します
-- =====================================================

-- 1. Drop Existing Tables & Types (Cascade to remove dependencies)
DROP TABLE IF EXISTS exclusion_pairs CASCADE;
DROP TABLE IF EXISTS standings CASCADE;
DROP TABLE IF EXISTS goals CASCADE;
DROP TABLE IF EXISTS players CASCADE;
DROP TABLE IF EXISTS matches CASCADE;
DROP TABLE IF EXISTS team_uniforms CASCADE;
...
DROP TYPE IF EXISTS match_stage CASCADE;
...
-- =====================================================
-- 4. Circular Dependencies (ALTERs)
-- =====================================================
